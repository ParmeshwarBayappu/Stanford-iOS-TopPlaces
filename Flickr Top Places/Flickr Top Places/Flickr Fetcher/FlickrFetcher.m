...
{
    //return [NSURL URLWithString: [NSString stringWithFormat:@"http://cdn2.gsmarena.com/vv/pics/apple/apple-iphone-5-front.jpg"]];
    //return [NSURL URLWithString: [NSString stringWithFormat:@"http://stackoverflow.com/questions/12622424/how-do-i-animate-constraint-changes"]];
...
+ (NSString *)extractCountryNameFromPlaceInformation:(NSDictionary *)place
{
    ...
    NSString *country = contentComponents.lastObject;
    return country;
}
